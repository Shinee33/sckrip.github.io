...
@section('content')
<div class="max-w-4xl mx-auto space-y-6" x-data="createProductForm()">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-[#111827]">Tambah Data Beras Baru</h1>
            <p class="text-xs text-[#6B7280]">Input data karakteristik beras dan informasi SNI untuk inventaris</p>
        </div>
        ...
        <div class="rounded-[14px] border border-[#E5E7EB] bg-white p-6 shadow-xs space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" placeholder="Contoh: IR64, Ciherang, Inpari 32, Mentik Wangi" required class="w-full rounded-xl border border-[#E5E7EB] px-3.5 py-2.5 text-xs text-[#111827] focus:border-[#0F766E] focus:outline-none focus:ring-1 focus:ring-[#0F766E] transition">
                </div>

                <!-- 3. Jenis Beras (Dropdown + Button Manage) -->
                <div>
            ...
            <div>
                ...
                <textarea name="description" rows="4" placeholder="Deskripsi lengkap mengenai beras (asal varietas, keunggulan, aroma, tekstur, kegunaan)" required class="w-full rounded-xl border border-[#E5E7EB] px-3.5 py-2.5 text-xs text-[#111827] focus:border-[#0F766E] focus:outline-none focus:ring-1 focus:ring-[#0F766E] transition">{{ old('description') }}</textarea>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input type="text" name="location" value="{{ old('location') }}" placeholder="Contoh: Kabupaten Karawang, Subang, Indramayu, Banyuwangi" required class="w-full rounded-xl border border-[#E5E7EB] px-3.5 py-2.5 text-xs text-[#111827] focus:border-[#0F766E] focus:outline-none focus:ring-1 focus:ring-[#0F766E] transition">
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="entry_date" value="{{ old('entry_date', date('Y-m-d')) }}" required class="w-full rounded-xl border border-[#E5E7EB] px-3.5 py-2.5 text-xs text-[#111827] focus:border-[#0F766E] focus:outline-none focus:ring-1 focus:ring-[#0F766E] transition">
                </div>
            </div>
            ...
            <div>
                ...
                <textarea name="specifications" rows="5" placeholder="Contoh isi:&#10;- Kadar Air: Max 14%&#10;- Butir Kepala: Min 85%&#10;- Butir Patah: Max 15%&#10;- Derajat Sosoh: Min 95%&#10;- Standar Mutu: SNI 6128:2020" required class="w-full rounded-xl border border-[#E5E7EB] px-3.5 py-2.5 text-xs font-mono text-[#111827] focus:border-[#0F766E] focus:outline-none focus:ring-1 focus:ring-[#0F766E] transition">{{ old('specifications') }}</textarea>
                <p class="mt-1 text-[11px] text-[#6B7280]">Data ini menjadi informasi utama saat pengguna memindai QR Code.</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div>
                    ...
                    <select name="unit" required class="w-full rounded-xl border border-[#E5E7EB] px-3.5 py-2.5 text-xs text-[#111827] focus:border-[#0F766E] focus:outline-none focus:ring-1 focus:ring-[#0F766E] transition">
                        ...
                        @foreach ($options as $opt)
                            <option value="{{ $opt }}" {{ old('unit', '12 Bulan') == $opt ? 'selected' : '' }}>{{ $opt }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="serial_number" value="{{ old('serial_number') }}" placeholder="Contoh: SNI 6128:2020, Sertifikat Halal MUI" class="w-full rounded-xl border border-[#E5E7EB] px-3.5 py-2.5 text-xs text-[#111827] focus:border-[#0F766E] focus:outline-none focus:ring-1 focus:ring-[#0F766E] transition">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="brand" value="{{ old('brand') }}" placeholder="Contoh: Simpan di tempat kering & sejuk" class="w-full rounded-xl border border-[#E5E7EB] px-3.5 py-2.5 text-xs text-[#111827] focus:border-[#0F766E] focus:outline-none focus:ring-1 focus:ring-[#0F766E] transition">
                </div>
            </div>
    ...
    <!-- Modal Kelola & Tambah Jenis Beras (Tabs + Edit + Hapus) -->
